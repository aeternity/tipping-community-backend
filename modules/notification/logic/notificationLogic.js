...
const NotificationLogic = {
  add: {
    [NOTIFICATION_TYPES.COMMENT_ON_TIP]: async (receiver, sender, commentId, tipId) =>
      Notification.create({
        receiver,
        sender,
    ...
    [NOTIFICATION_TYPES.COMMENT_ON_COMMENT]: async (receiver, sender, commentId, parentCommentId) =>
      Notification.create({
        receiver,
        sender,
    ...
    [NOTIFICATION_TYPES.TIP_ON_COMMENT]: async (receiver, sender, tipId, commentId) =>
      Notification.create({
        receiver,
        sender,
    ...
    [NOTIFICATION_TYPES.RETIP_ON_TIP]: async (receiver, sender, tipId, retipId) =>
      Notification.create({
        receiver,
        sender,
    ...
    [NOTIFICATION_TYPES.CLAIM_OF_RETIP]: async (receiver, tipId, retipId) =>
      Notification.create({
        receiver,
  ...
  async bulkUpdateNotificationStatus(ids, status) {
    ...
    return Notification.bulkCreate(
      results.map((notification) => ({ ...notification.toJSON(), status })),
  ...
  async handleClaim(claim) {
    ...
    await Promise.all(
      relevantRetips.map(async (retip) => {
