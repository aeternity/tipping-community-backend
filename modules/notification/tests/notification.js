...
import { ENTITY_TYPES, NOTIFICATION_TYPES, NOTIFICATION_STATES, SOURCE_TYPES } from "../constants/notification.js";
...
describe("Notifications", () => {
  ...
  describe("Retrieve Notifications", () => {
    it("it should GET zero notifications for a user", (done) => {
      performSignedGETRequest(server, `/notification/user/${publicKey}`).then(({ res }) => {
