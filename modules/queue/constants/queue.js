...
const MESSAGES = {
  ...
  TIPS: {
    COMMANDS: {
      ...
      INSERT_CLAIM: 'TIPS.COMMANDS.INSERT_CLAIM',
    },
    EVENTS: {
  ...
  SCHEDULED_EVENTS: {
    COMMANDS: {
      ...
      UPDATE_EVENTS: 'SCHEDULED_EVENTS.COMMANDS.UPDATE_EVENTS',
      UPDATE_LINKPREVIEWS: 'SCHEDULED_EVENTS.COMMANDS.UPDATE_LINKPREVIEWS',
    },
  },
};
if (process.env.NODE_ENV === 'test') {
