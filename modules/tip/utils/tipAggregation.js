...
module.exports = {
  ...
  TOTAL_AMOUNT_FOR_ORDER: [Tip.sequelize.literal('(SELECT "TipsAggregation"."totalamount" FROM TipsAggregation AS "TipsAggregation" WHERE "TipsAggregation"."id" = "Tip"."id")'), 'totalAmountForOrder'],
